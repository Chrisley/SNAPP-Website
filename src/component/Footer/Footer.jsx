...
<footer className=" bottom-0 right-0 left-0  z-10 bg-black text-white pt-20 pb-10 lg:pt-[120px] lg:pb-20">
    ...
    <div className="ml-8 flex flex-wrap">
      <div className="w-full px-4 sm:w-2/3 lg:w-5/12 md:w-full">
        <div className="mb-10 w-full">
          <a href="Footer" className="mb-6 inline-block max-w-[160px]">
            <img
      ...
      <div className="w-full px-4 sm:w-1/2 lg:w-2/12 md:w-1/3">
        <div className="mb-10 w-full">
          <h4 className="text-dark mb-9 text-lg font-semibold">Support</h4>
      ...
      <div className="w-full px-4 sm:w-1/2 lg:w-2/12 md:w-1/3">
        <div className="mb-10 w-full">
          <h4 className="text-dark mb-9 text-lg font-semibold">Explore</h4>
          <ul className='text-gray-300 text-xs font-normal'>
            <li>
              <a
                href="Footer"
      ...
      <div className="w-full px-4 sm:w-1/2 lg:w-3/12 md:w-1/3">
        <div className="mb-10 w-full">
          <h4 className="text-dark mb-9 text-lg font-semibold">Connect</h4>
          <ul className=' text-gray-300 text-xs font-normal'>
            <li>
            <p className="text-body-color hover:text-success mb-2 inline-block  leading-loose">
                  Email: support@safenaija.com
                 </p>
            </li>
            <li>
            <p  className="text-body-color hover:text-success mb-2 inline-block leading-loose">
                Phone: (+234)90-909-489
                </p>
            </li>
            <li >
          ...
          <svg xmlns="http://www.w3.org/2000/svg" x="0px" y="0px"
            width="24" height="24"
            viewBox="0 0 24 24">
                <path d="M17.525,9H14V7c0-1.032,0.084-1.682,1.563-1.682h1.868v-3.18C16.522,2.044,15.608,1.998,14.693,
                2 C11.98,2,10,3.657,10,6.699V9H7v4l3-0.001V22h4v-9.003l3.066-0.001L17.525,9z"></path>
          </svg>
            </a>
            ...
            >
              <svg xmlns="http://www.w3.org/2000/svg"  viewBox="0 0 24 24" width="24px" height="24px"> 
                 <path d="M 8 3 C 5.239 3 3 5.239 3 8 L 3 16 C 3 18.761 5.239 21 8 21 L 16 21 C 18.761 21
            ...
            >
              <svg width="20" height="20" viewBox="0 0 13 14" fill="none" xmlns="http://www.w3.org/2000/svg">
                <path d="M0.915 3.9501C1.43501 2.91462 2.23273 2.04417 3.21902 1.43602C4.20531 0.827864 5.34129 0.505983 6.5 
                ...
                4.79385 0.915 3.9501Z" fill="black"/>
              </svg>
            ...
            >
             <svg width="20" height="20" viewBox="0 0 13 11" fill="none" xmlns="http://www.w3.org/2000/svg">
                <path d="M12.75 1.88123C12.2802 2.08504 11.7834 2.21977 11.275 2.28123C11.8114 1.96081 12.2133 1.45672 
                ...
                1.14373C0.893211 1.53759 0.7747 1.98362 0.775 2.43748C0.7742 2.85897 0.877636 3.27412 1.0761 3.64596C1.27456 4.0178 1.56189 4.3348
                 ...
                 0.25 9.68124C1.42152 10.4376 2.78676 10.8392 4.18125 10.8375C5.14356 10.8475 6.09821 10.6656 6.98945 10.3025C7.88068 9.93945 8.69064 9.40241 9.372 8.72279C10.0534
                  8.04318 10.5925 7.2346 10.9578 6.3443C11.3232 5.454 11.5075 4.49981 11.5 3.53748V3.20623C11.9904 2.84049 12.4134 2.39213 12.75 1.88123Z" fill="black"/>
             </svg>
  ...
  <p className="text-gray-400 text-center text-sm">&copy; 2023 Moohub technologies. All Rights Reserved</p>
  </div>
  {/*<div>
